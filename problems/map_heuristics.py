...
class AirDistHeuristic(HeuristicFunction):
    ...
    def estimate(self, state: GraphProblemState) -> float:
        ...
        st_map = self.problem.streets_map
        curr_junction = st_map[state.junction_id]
        goal_junction = st_map[self.problem.target_junction_id]
        return curr_junction.calc_air_distance_from(goal_junction)
